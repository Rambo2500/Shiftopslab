...
class ProductionService:
    def __init__(self, data_path: str = "engines/facility-engine/production/outputs/data/truth_table.csv"):
    ...
    def get_current_metrics(self) -> List[ProductionMetric]:
        ...
        for line, group in df.groupby('line_id'):
            planned = group['ordered_qty'].sum()
            actual = group['produced_qty'].sum()
